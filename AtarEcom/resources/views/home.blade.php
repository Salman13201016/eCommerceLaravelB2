    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          <div class="head"><i class="icon fa fa-align-justify fa-fw"></i> Categories1</div>
          <nav class="yamm megamenu-horizontal">
            @foreach($data as $d1)
              @php $cat = $d1->first(); @endphp
            <ul class="nav">
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-shopping-bag" aria-hidden="true"></i>{{$cat->catSubcat->cat_name}}</a>
                    ...
                    <div class="row">
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                          @foreach($d1 as $d2)
                          <li><a href="#">{{$d2->sub_cat_name}}</a></li>
                          @endforeach
                        </ul>
                      </div>
                      <!-- /.col --> 
